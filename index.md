...
##### Figure 1: Comparison of the satellite image with its corresponding mask and the predicted mask
...
[![](https://img.shields.io/badge/published-Landscape%20and%20Urban%20Planning-lightgrey?labelColor=white)](#)
...
<img src="images/visual_abstract.png?raw=true" width=auto height=270/>
...
## Teaching experience as lecturer at the University of Bern

### Autumn semester 2023: Machine Learning and Artificial Neural Networks
Topics:
...
### Autumn semester 2021: Machine Learning
Topics:
* Ordinary Least Squares (OLS) regression
* Logit regression
* Fitting, predicting, and optimization
